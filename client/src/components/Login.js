              ...
              <div class='mt-8 w-full px-2 sm:px-6'>
                <div class='flex flex-col mt-8'>
                  ...
                  <input
                    ...
                    aria-required='true'
                    name='username'
                    class='h-8 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow'
                    type='text'
              ...
              <div class='pt-6 w-full flex justify-between px-2 sm:px-6'>
                <div class='flex items-center'>
                  <input
                    ...
                    type='checkbox'
                  />
                  <label for='rememberme' class='text-xss'>
                    Remember Me
                  </label>
                </div>
              </div>
